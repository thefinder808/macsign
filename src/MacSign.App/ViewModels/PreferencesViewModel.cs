...
/// <summary>
/// Preferences screen: Appearance (theme), Signing defaults, and Activity/data
/// housekeeping. Owns only prefs state + persistence; cross-VM actions
/// (clear history, re-trim, reset all) are raised as events the shell coordinates.
